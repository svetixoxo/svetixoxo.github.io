...
<style>
  ...
  #ueber-mich__aufmacher .aufmacher-haupt {
    border-right: none;
  }
...
<div class="ueber-raster">
  ...
  <div class="artikel-rahmen">
    <p>In zwei Bereichen kommt hier KI zum Einsatz: Von JavaScript habe ich keine Ahnung, also kam das von Anthropic Claude. Die Grafiken basieren auf einem Foto von mir und kommen von OpenAI ChatGPT, mussten aber noch angepasst werden.</p>
  </div>
</div>
